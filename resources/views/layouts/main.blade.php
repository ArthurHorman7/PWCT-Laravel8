...
<!--Fecha Modal Register-->
    ...
    <nav style="max-width: 100%;" class="navbar navbar-expand-md navbar-light bg-light fixed-top py-1 pl-0 box-shadow">
        ...
        <button class="navbar-toggler bt-resp" type="button" data-toggle="collapse" data-target="#navbarNavDropdown"
        ...
        <div class="collapse navbar-collapse " id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto h5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-primary" href="\contato">
                        <img class="img-user" src="../img/user.png" alt="User">
                    </a>
                </li>-->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item text-primary" href="\dashboard">Meus Cursos</a>

                            <form action="/logout" method="POST">
                        @csrf
                            <a class="dropdown-item text-primary" href="/logout"
                            onclick="event.preventDefault();
                            this.closest('form').submit();">Sair</a>
                        </form>
